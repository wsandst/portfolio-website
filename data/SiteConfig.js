const config = {
  ...
  siteTitleShort: "WSAND", // Short site title for homescreen (PWA). Preferably should be under 12 characters to prevent truncation.
  ...
  userLocation: "Umeå, Sweden, Earth", // User location to display in the author segment.
